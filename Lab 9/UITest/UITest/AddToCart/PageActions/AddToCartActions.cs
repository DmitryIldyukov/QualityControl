...
public class AddToCartActions
{
    ...
    private static readonly By _firstProductXPath = By.XPath("//a[text()='qwer']");
    private static readonly By _secondProductXPath = By.XPath("//a[text()='1234']");
    ...
    private const string FIRST_PRODUCT_NAME = "QWER";
    private const string SECOND_PRODUCT_NAME = "1234";
    ...
    public bool CheckingCartWithOneProduct()
    {
        ...
        var totalQuantity = _webDriver.FindElement(_totalQuantityWithOneProductXPath).Text;
        var totalPrice = _webDriver.FindElement(_totalPriceWithOneProductXPath).Text;

        if (int.Parse(totalQuantity) != int.Parse(firstProductQuantity)) return false;
        if (totalPrice != $"${int.Parse(firstProductPrice) * int.Parse(firstProductQuantity)}") return false;
